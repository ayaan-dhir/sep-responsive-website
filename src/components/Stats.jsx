...
const Stats = () => {
  return (
    <div className="join join-vertical lg:join-horizontal flex items-center justify-center h-screen w-full gap-x-20 px-6 gap-y-5 pt-[96px]">
      <div className="card card-normal rounded-[22px] bg-primary w-64 md:w-96 sm:w-80 text-white text-center hover:scale-110 duration-300">
      ...
      <div className="card card-normal rounded-[22px] bg-primary w-64 md:w-96 sm:w-80 bg- text-white text-center hover:scale-110 duration-300">
        <div className="card-body">
          <h1 className="card-title justify-center md:text-6xl sm:text-5xl text-4xl">
            1
          </h1>
