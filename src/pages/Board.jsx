...
function Board() {
  return (
    <div data-theme="light" className="text-center pt-[96px]">
      <h1 className="font-semibold text-[56pt] text-black md:pt-10">Board</h1>
      <div className="grid justify-center grid-cols-[repeat(auto-fill,minmax(250px,1fr))] lg:gap-x-[150px] lg:gap-y-[100px] gap-[100px] pl-[100px] pr-[100px] pt-[50px] pb-[50px]">
        {boardData.map((member) => (
          <div key={member.id} className="flex flex-col items-center">
            ...
            />
            <div className="font-bold text-[16pt] mt-[5px] text-black">
              {member.position}
            </div>
